namespace WebServer
{
    ...
    public class WebServer : IRunnable
    {
        ...
        public WebServer(int port, IHandleable mvcRequestHandler, IHandleable mvcResourceHandler)
        {
            this.port = port;
        ...
        private async Task ListenLoop()
        {
            while (this.isRunning)
            {
                ...
                var connectionHandler = new ConnectionHandler(client, this.mvcRequestHandler, this.mvcResourceHandler);
