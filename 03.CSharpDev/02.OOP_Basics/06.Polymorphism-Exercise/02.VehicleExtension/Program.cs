...
public class Program
{
    static void Main()
    {
        ...
        var bussArgs = Console.ReadLine().Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        var bus = new Bus(double.Parse(bussArgs[1]), double.Parse(bussArgs[2]), double.Parse(bussArgs[3]));
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            switch (commandArgs[1])
            {
                ...
                case "Truck":
                    ...
                    break;
                case "Bus":
                    ExecuteCommand(commandArgs, bus);
                    break;
            }
        }
    ...
    private static void ExecuteCommand(string[] commandArgs, Vehical vehicle)
    {
        ...
        switch (commandArgs[0])
        {
            case "Drive":
                ...
                break;
            case "DriveEmpty":
                Console.WriteLine(vehicle.Drive(double.Parse(commandArgs[2])), true);
                break;
            case "Refuel":
