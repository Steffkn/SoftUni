...
public class TaskController {
	...
	public String createProcess(Model model, TaskBindingModel taskBindingModel) {
		...
		Task aa = new Task();
		aa.setTitle(taskBindingModel.getTitle());
		aa.setStatus(taskBindingModel.getStatus());
		taskRepository.saveAndFlush(aa);
		return "redirect:/";
	}
	...
	public String editProcess(Model model, @PathVariable int id, TaskBindingModel taskBindingModel) {
        ...
        if (taskBindingModel.getTitle().equals("") ||(
                !taskBindingModel.getStatus().equals("Open") &&
                !taskBindingModel.getStatus().equals("In Progress") &&
